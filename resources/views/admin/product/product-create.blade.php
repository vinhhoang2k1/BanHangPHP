...
@section('header')
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item "><a href="#">Thêm sản phẩm</a></div>
    </div>
@endsection
        ...
        <div class="card w-100">
            <div class="card-body">
                <form action="{{ route('products.store') }}" method="post" enctype="multipart/form-data" id="my-form">
                            ...
                            <div class="form-group">
                                ...
                                <select name="category_id" class="form-control select2" style="width:100%;">
                                    @foreach($categories as $category)
                                        @if(old('post_category_id') == $category['id'])
                    ...
                    <div class="form-row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ old('price') }}" name="price" class="form-control @error('price') is-invalid @enderror" placeholder="Nhập tên giá">
                                @error('price')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ old('quantity') }}" name="quantity" class="form-control @error('quantity') is-invalid @enderror" placeholder="Nhập giá sản phẩm">
                                @error('quantity')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-group">
                        <label>Mô tả</label>
                        <textarea name="description" id="text" cols="30" rows="10">{{ old('description') }}</textarea>
                        @error('description')
                        <div class="invalid-feedback d-block">
                            {{ $message }}
                        </div>
                    ...
                    <div class="form-row">
                        <div class="col-4">
                            <div class="form-group">
                                <label class="custom-switch mt-2">
                                    <input type="checkbox" value="1"  @if(old('selling_product')) checked @endif name="selling_product" class="custom-switch-input">
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                <label class="custom-switch mt-2">
                                    <input type="checkbox" value="1" @if(old('common')) checked @endif name="common" class="custom-switch-input">
                                    <span class="custom-switch-indicator"></span>
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                <label class="custom-switch mt-2">
                                    <input type="checkbox" value="1" name="new_product" @if(old('new_product')) checked @endif class="custom-switch-input">
                                    <span class="custom-switch-indicator"></span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="thumbnail">
                            ...
                            <img class="img-fluid thumbnail-upload" style="width: 100px; height: 130px; object-fit: cover; object-position: center" src="{{ asset('assets/img/thumbnail.png') }}" alt="">
                        </div>
                    </div>
                    <div class="form-group">
                        <ul class="nav">
